...
<div class="bottom_bar">
  操作: <label><input type="checkbox" onclick="$('.id_sel').prop('checked',this.checked);" /> 全选</label> 将选中项 <a href="javascript:void(0)" onclick="multi_opt('<?php echo U('album','album','a=trash');?>','您是要删除选定项么？')">移动到回收站</a>
</div>
<?php echo $pagestr; ?>