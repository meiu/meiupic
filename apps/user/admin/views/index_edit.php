<a href="<?php echo U('user','index');?>" >&lt;&lt;返回</a><br>
<form id="submit_form" class="ajaxform" method="post">
    <table class="edit_table">
        ...
        <tr>
        <th>会员级别：</th>
        <td><input type="text" name="level" size="20" value="<?php echo $info['level'];?>" /> (99为管理员)</td>
        </tr>
        <!--额外字段开始-->
        <?php for($i=1;$i<=8;$i++):
        ...
        <tr>
        <th></th>
        <td><input type="submit" class="submit-btn" value="保存修改" /></td>
        </tr>
    </table>
</form>