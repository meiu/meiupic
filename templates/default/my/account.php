...
<div class="container">
    ...
    <div class="content">
        <form class="form-basic ajaxform" method="post" action="<?=U('my','account','a=savebind')?>">
            <div class="line-wrap"> 
            ...
            <div class="line-wrap">             
                ...
                <div class="input-wrap">
                    <input type="text" class="nomal-input <?php if($_G['user']['email_actived']){echo 'readonly';} ?>" name="email" value="<?=$_G['user']['email']?>" autocomplete="off" data-target="form-basic" <?php if($_G['user']['email_actived']){echo 'readonly="readonly"';} ?>>
            ...
            <div class="line-wrap">             
                ...
                <div class="input-wrap">
                    <input type="text" class="nomal-input <?php if($_G['user']['mobile_actived']){echo 'readonly';} ?>" placeholder="输入手机号" id="mobile" name="mobile" value="<?=$_G['user']['mobile']?>" autocomplete="off" data-target="form-basic" <?php if($_G['user']['mobile_actived']){echo 'readonly="readonly"';} ?>>
...
<script>
    $(function(){
        $('#send_active_code').click(function(){
            $.post('<?=U('my','account','a=send_activecode')?>',{isajax:1},function(data){
