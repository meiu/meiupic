...
<div class="photo_thumbnail">
    <a href="<?php echo U('album','space','id='.$uid.'&aid='.$value['id']);?>" class="album_link"></a>
    <div class="top" style="background-image:url('<?php echo thumb($value['cover_path'],600,600,2);?>');">
    </div>
    <div class="bottom">
        <a href="<?php echo U('album','space','id='.$uid.'&aid='.$value['id']);?>" class="name"><?php echo $value['name'];?></a>
